...
if(isset($_POST['signup']))
{
    ...
    $sql="insert into signup(firstname,lastname,email,zipcode,gender,birthday,income,job_industry,role,job_title,password,username)values('$fname','$lname','$email','$zipcode','$gender','$birthday','$income','$job_industry','$role','$job_title','$hashedPassword','$username')";
  ...
  >
    ...
    <div id="content">
      <nav class="nav w-full mb-12">
        ...
        <a href="index.php" class="inline-block w-[150px] h-auto">
          <img src="imgs/signup.png" alt="Sign Up" class="w-full h-auto" />
        </a>
            ...
            >
              ...
              <div class="form grid grid-cols-1 sm:grid-cols-2 gap-8 py-12">
                ...
                >
                  ...
                  >
                    I agree to the Terms of Use and to receive marketing email
                    messages from Opinion Elite, and I accept the Privacy
                    Policy.
                  </p>
                </div>
              </div>
