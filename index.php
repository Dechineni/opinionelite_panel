...
<html lang="en">
  ...
  >
    <div id="content">
      ...
      <main class="main flex flex-col w-full">
        <section class="intro w-full relative">
          ...
          >
            ...
            >
              <h1
                class="text-[50px] md:text-[70px] text-white font-semibold leading-none tracking-[-0.03em] mb-8"
              >
                Join the Elite
              </h1>
              <p
              ...
              >
                ...
                <a
                  href="linked_in.php"
                  class="relative w-[300px] h-[80px] flex items-center justify-center rounded-full overflow-hidden"
                >
                  <img
                    src="imgs/join-button.png"
                    alt="Join via LinkedIn"
                ...
                <a
                  href="#"
                  class="relative w-[300px] h-[80px] flex items-center justify-center rounded-full overflow-hidden opacity-70 cursor-not-allowed"
                  title="Facebook sign-in coming soon"
                >
                  <img
                    src="imgs/join-button.png"
                    alt="Join via Facebook"
                    class="absolute inset-0 w-full h-full object-cover"
                  />
                  <span
                    class="relative z-[10] flex items-center gap-3 text-[16px] font-bold tracking-[0.03em] leading-none uppercase"
            ...
            <!-- RIGHT SIDE: phone mockup / video (same as current index.php) -->
            <div
      ...
      <!-- Legal modal + preloader (same as current index.php) -->
      <div
        id="legal-modal"
